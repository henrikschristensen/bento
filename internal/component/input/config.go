...
type Config struct {
	...
	// LazyLoad, when true and the config is used as an input resource, defers
	// construction of the underlying input until it is first accessed. It has
	// no effect on inline inputs.
